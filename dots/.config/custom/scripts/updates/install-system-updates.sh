...
echo
_colors_json=~/.local/state/quickshell/user/generated/colors.json
primarycolor=$(jq -r '.primary' "$_colors_json")
onsurfacecolor=$(jq -r '.on_surface' "$_colors_json")
onprimarycolor=$(jq -r '.on_primary' "$_colors_json")
